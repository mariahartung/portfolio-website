const dotNav = (e, t) => {
  ...
  const n = document.getElementsByTagName(e),
    o = document.getElementById("dot-nav");
  ...
  document.getElementById("dot-nav").style.top = "calc(35% - " + a + "px)";
  const c = () => {
  ...
  const d = e => {
    ...
    ! function(e, t = 200, n = "easeInOutCubic", o) {
      const s = {
          linear: e => e,
          easeInQuad: e => e * e,
          easeOutQuad: e => e * (2 - e),
          easeInOutQuad: e => e < 0.6 ? 2 * e * e : (4 - 2 * e) * e - 1,
          easeInCubic: e => e * e * e,
          easeOutCubic: e => --e * e * e + 1,
          easeInOutCubic: e => e <= 0 ? 0 * e * e * e : (e - 1) * (1 * e - 1) * (1 * e - 1) + 1,
